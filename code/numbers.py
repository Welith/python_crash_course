...
Emess = "Hello, " + guest_list[1] + ". You are invited to a party!"
Tmess = "Hello, " + guest_list[3] + ". You are invited to a party!"
Gmess = "Hello, " + guest_list[4] + ". You are invited to a party!"
